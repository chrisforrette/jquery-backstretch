...
Setting this to true will make it so that the image is not stretched beyond its original dimensions (type=Boolean, default=false)
...
* Added a 'constrain' option that defaults to false and, when set to true, the image will not be stretched beyond its original dimensions.
